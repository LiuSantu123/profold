#!/usr/bin/env python3
"""Aggregate Level 2 shard outputs."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Aggregate v37 Level 2")
    ...
    print(f"aggregated level2: {len(rows)} rows -> {run / 'results/result_manifest.tsv'}; {counts}")
    return 0
