#!/usr/bin/env python3
"""Prepare an independent Level 2 Protenix/Boltz-2/OpenDDE run."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Prepare v37 Level 2 run")
    ...
    print(f"prepared level2: {len(rows)} tasks, {output / 'tasks/n_shards.txt'}")
    return 0
