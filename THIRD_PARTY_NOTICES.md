...
OpenDDE conversion/launcher scripts come from existing local workflow adapters.
Model packages, datasets, pretrained parameters and third-party executables are
not bundled. Install them separately under their upstream terms. No new blanket
license is assigned to third-party software by this release.
